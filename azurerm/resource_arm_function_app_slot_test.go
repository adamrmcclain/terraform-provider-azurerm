		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					...
					testCheckAzureRMFunctionAppSlotHasNoContentShare(resourceName),
				),
			},
			{
...
func TestAccAzureRMFunctionAppSlot_requiresImport(t *testing.T) {
	...
	//applicationName := "azurerm_function_app.test"
	resourceName := "azurerm_function_app_slot.test"
	ri := tf.AccRandTimeInt()
...
func TestAccAzureRMFunctionAppSlot_tags(t *testing.T) {
	resourceName := "azurerm_function_app_slot.test"
	ri := tf.AccRandTimeInt()
	rs := strings.ToLower(acctest.RandString(11))
	config := testAccAzureRMFunctionAppSlot_tags(ri, rs, testLocation())
...
func TestAccAzureRMFunctionAppSlot_tagsUpdate(t *testing.T) {
	...
	rs := strings.ToLower(acctest.RandString(11))
	config := testAccAzureRMFunctionAppSlot_tags(ri, rs, testLocation())
	updatedConfig := testAccAzureRMFunctionAppSlot_tagsUpdated(ri, rs, testLocation())
...
func TestAccAzureRMFunctionAppSlot_appSettings(t *testing.T) {
	...
	rs := strings.ToLower(acctest.RandString(11))
	config := testAccAzureRMFunctionAppSlot_basic(ri, rs, testLocation())
	updatedConfig := testAccAzureRMFunctionAppSlot_appSettings(ri, rs, testLocation())
...
func TestAccAzureRMFunctionAppSlot_siteConfig(t *testing.T) {
	resourceName := "azurerm_function_app_slot.test"
	ri := tf.AccRandTimeInt()
	rs := strings.ToLower(acctest.RandString(11))
	config := testAccAzureRMFunctionAppSlot_alwaysOn(ri, rs, testLocation())
...
func TestAccAzureRMFunctionAppSlot_linuxFxVersion(t *testing.T) {
	resourceName := "azurerm_function_app_slot.test"
	ri := tf.AccRandTimeInt()
	rs := strings.ToLower(acctest.RandString(11))
	config := testAccAzureRMFunctionAppSlot_linuxFxVersion(ri, rs, testLocation())
...
func TestAccAzureRMFunctionAppSlot_connectionStrings(t *testing.T) {
	...
	ri := tf.AccRandTimeInt()
	rs := strings.ToLower(acctest.RandString(11))
	config := testAccAzureRMFunctionAppSlot_connectionStrings(ri, rs, testLocation())
...
func TestAccAzureRMFunctionAppSlot_siteConfigMulti(t *testing.T) {
	resourceName := "azurerm_function_app_slot.test"
	ri := tf.AccRandTimeInt()
	rs := strings.ToLower(acctest.RandString(11))
	configBase := testAccAzureRMFunctionAppSlot_basic(ri, rs, testLocation())
	configUpdate1 := testAccAzureRMFunctionAppSlot_appSettings(ri, rs, testLocation())
	configUpdate2 := testAccAzureRMFunctionAppSlot_appSettingsAlwaysOn(ri, rs, testLocation())
	configUpdate3 := testAccAzureRMFunctionAppSlot_appSettingsAlwaysOnLinuxFxVersion(ri, rs, testLocation())
	configUpdate4 := testAccAzureRMFunctionAppSlot_appSettingsAlwaysOnLinuxFxVersionConnectionStrings(ri, rs, testLocation())
...
func TestAccAzureRMFunctionAppSlot_updateVersion(t *testing.T) {
	...
	ri := tf.AccRandTimeInt()
	rs := strings.ToLower(acctest.RandString(11))
	preConfig := testAccAzureRMFunctionAppSlot_version(ri, rs, testLocation(), "~1")
	postConfig := testAccAzureRMFunctionAppSlot_version(ri, rs, testLocation(), "~2")
...
func TestAccAzureRMFunctionAppSlot_3264bit(t *testing.T) {
	resourceName := "azurerm_function_app_slot.test"
	ri := tf.AccRandTimeInt()
	rs := strings.ToLower(acctest.RandString(11))
	location := testLocation()
	config := testAccAzureRMFunctionAppSlot_basic(ri, rs, location)
	updatedConfig := testAccAzureRMFunctionAppSlot_64bit(ri, rs, location)
...
func TestAccAzureRMFunctionAppSlot_httpsOnly(t *testing.T) {
	...
	rs := strings.ToLower(acctest.RandString(11))
	location := testLocation()
	config := testAccAzureRMFunctionAppSlot_httpsOnly(ri, rs, location)
...
func TestAccAzureRMFunctionAppSlot_consumptionPlan(t *testing.T) {
	resourceName := "azurerm_function_app_slot.test"
	ri := tf.AccRandTimeInt()
	rs := strings.ToLower(acctest.RandString(11))
	location := testLocation()
	config := testAccAzureRMFunctionAppSlot_consumptionPlan(ri, rs, location)
		...
		Steps: []resource.TestStep{
			{
				...
				Check: resource.ComposeTestCheckFunc(
					testCheckAzureRMFunctionAppSlotExists(resourceName),
					testCheckAzureRMFunctionAppSlotHasContentShare(resourceName),
					resource.TestCheckResourceAttr(resourceName, "site_config.0.use_32_bit_worker_process", "true"),
				),
			},
		},
...
func TestAccAzureRMFunctionAppSlot_consumptionPlanUppercaseName(t *testing.T) {
	resourceName := "azurerm_function_app_slot.test"
	ri := tf.AccRandTimeInt()
	rs := strings.ToLower(acctest.RandString(11))
	location := testLocation()
	config := testAccAzureRMFunctionAppSlot_consumptionPlanUppercaseName(ri, rs, location)
...
func TestAccAzureRMFunctionAppSlot_createIdentity(t *testing.T) {
	resourceName := "azurerm_function_app_slot.test"
	ri := tf.AccRandTimeInt()
	rs := strings.ToLower(acctest.RandString(11))
	config := testAccAzureRMFunctionAppSlot_basicIdentity(ri, rs, testLocation())
...
func TestAccAzureRMFunctionAppSlot_updateIdentity(t *testing.T) {
	resourceName := "azurerm_function_app_slot.test"
	ri := tf.AccRandTimeInt()
	rs := strings.ToLower(acctest.RandString(11))

	preConfig := testAccAzureRMFunctionAppSlot_basic(ri, rs, testLocation())
	postConfig := testAccAzureRMFunctionAppSlot_basicIdentity(ri, rs, testLocation())
...
func TestAccAzureRMFunctionAppSlot_loggingDisabled(t *testing.T) {
	resourceName := "azurerm_function_app_slot.test"
	ri := tf.AccRandTimeInt()
	rs := strings.ToLower(acctest.RandString(11))
	config := testAccAzureRMFunctionAppSlot_loggingDisabled(ri, rs, testLocation())
...
func TestAccAzureRMFunctionAppSlot_updateLogging(t *testing.T) {
	resourceName := "azurerm_function_app_slot.test"
	ri := tf.AccRandTimeInt()
	rs := strings.ToLower(acctest.RandString(11))
	location := testLocation()

	enabledConfig := testAccAzureRMFunctionAppSlot_basic(ri, rs, location)
	disabledConfig := testAccAzureRMFunctionAppSlot_loggingDisabled(ri, rs, location)
...
func TestAccAzureRMFunctionAppSlot_authSettings(t *testing.T) {
	...
	config := testAccAzureRMFunctionAppSlot_authSettings(ri, rs, testLocation(), tenantID)
...
func TestAccAzureRMFunctionAppSlot_corsSettings(t *testing.T) {
	...
	ri := tf.AccRandTimeInt()
	rs := strings.ToLower(acctest.RandString(11))
	config := testAccAzureRMFunctionAppSlot_corsSettings(ri, rs, testLocation())
...
func TestAccAzureRMFunctionAppSlot_vnetName(t *testing.T) {
	resourceName := "azurerm_function_app_slot.test"
	ri := tf.AccRandTimeInt()
	rs := strings.ToLower(acctest.RandString(11))
	vnetName := strings.ToLower(acctest.RandString(11))
	config := testAccAzureRMFunctionAppSlot_vnetName(ri, rs, testLocation(), vnetName)
...
func testCheckAzureRMFunctionAppSlotExists(resourceName string) resource.TestCheckFunc {
	return func(s *terraform.State) error {
		...
		functionAppName := rs.Primary.Attributes["app_service_name"]
		if !hasResourceGroup {
			return fmt.Errorf("Bad: no resource group found in state for Function App: %s - %s", functionAppName, slot)
		}
		...
		if err != nil {
			if utils.ResponseWasNotFound(resp.Response) {
				return fmt.Errorf("Bad: Function App %s - %q (resource group: %q) does not exist", functionAppName, slot, resourceGroup)
			}
...
func testCheckAzureRMFunctionAppSlotHasContentShare(resourceName string) resource.TestCheckFunc {
	return func(s *terraform.State) error {
		// Ensure we have enough information in state to look up in API
		rs, ok := s.RootModule().Resources[resourceName]
		if !ok {
		...
		appSettingsResp, err := client.ListApplicationSettings(ctx, resourceGroup, fmt.Sprintf("%s/slots/%s", functionAppName, slot))
		if err != nil {
...
func testCheckAzureRMFunctionAppSlotHasNoContentShare(resourceName string) resource.TestCheckFunc {
	return func(s *terraform.State) error {
		// Ensure we have enough information in state to look up in API
		rs, ok := s.RootModule().Resources[resourceName]
		if !ok {
...
func testAccAzureRMFunctionAppSlot_requiresImport(rInt int, storage, location string) string {
...
func testAccAzureRMFunctionAppSlot_tags(rInt int, storage string, location string) string {
	return fmt.Sprintf(`
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-%[1]d"
  location = "%[2]s"
...
func testAccAzureRMFunctionAppSlot_tagsUpdated(rInt int, storage string, location string) string {
	return fmt.Sprintf(`
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-%[1]d"
  location = "%[2]s"
...
func testAccAzureRMFunctionAppSlot_version(rInt int, storage string, location string, version string) string {
	return fmt.Sprintf(`
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-%[1]d"
  location = "%[2]s"
...
resource "azurerm_function_app_slot" "test" {
  ...
  app_service_plan_id = "${azurerm_app_service_plan.test.id}"
  storage_connection_string = "${azurerm_storage_account.test.primary_connection_string}"
  version                   = "${azurerm_function_app.test.version}"
}
`, rInt, location, storage, version)
}

func testAccAzureRMFunctionAppSlot_appSettings(rInt int, rString, location string) string {
	return fmt.Sprintf(`
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-%[1]d"
  location = "%[2]s"
...
func testAccAzureRMFunctionAppSlot_alwaysOn(rInt int, rString, location string) string {
	return fmt.Sprintf(`
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-%[1]d"
  location = "%[2]s"
...
func testAccAzureRMFunctionAppSlot_linuxFxVersion(rInt int, rString, location string) string {
	return fmt.Sprintf(`
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-%[1]d"
  location = "%[2]s"
...
func testAccAzureRMFunctionAppSlot_connectionStrings(rInt int, rString, location string) string {
	return fmt.Sprintf(`
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-%[1]d"
  location = "%[2]s"
...
func testAccAzureRMFunctionAppSlot_appSettingsAlwaysOn(rInt int, rString, location string) string {
	return fmt.Sprintf(`
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-%[1]d"
  location = "%[2]s"
...
func testAccAzureRMFunctionAppSlot_appSettingsAlwaysOnLinuxFxVersion(rInt int, rString, location string) string {
	return fmt.Sprintf(`
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-%[1]d"
  location = "%[2]s"
...
func testAccAzureRMFunctionAppSlot_appSettingsAlwaysOnLinuxFxVersionConnectionStrings(rInt int, rString, location string) string {
	return fmt.Sprintf(`
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-%[1]d"
  location = "%[2]s"
...
func testAccAzureRMFunctionAppSlot_64bit(rInt int, rString string, location string) string {
	return fmt.Sprintf(`
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-%d"
  location = "%s"
...
func testAccAzureRMFunctionAppSlot_httpsOnly(rInt int, rString string, location string) string {
	return fmt.Sprintf(`
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-%d"
  location = "%s"
...
func testAccAzureRMFunctionAppSlot_consumptionPlan(rInt int, rString string, location string) string {
	return fmt.Sprintf(`
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-%d"
  location = "%s"
...
func testAccAzureRMFunctionAppSlot_consumptionPlanUppercaseName(rInt int, rString string, location string) string {
	return fmt.Sprintf(`
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-%d"
  location = "%s"
...
func testAccAzureRMFunctionAppSlot_basicIdentity(rInt int, storage string, location string) string {
	return fmt.Sprintf(`
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-%[1]d"
  location = "%[2]s"
...
func testAccAzureRMFunctionAppSlot_loggingDisabled(rInt int, storage string, location string) string {
	return fmt.Sprintf(`
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-%[1]d"
  location = "%[2]s"
...
func testAccAzureRMFunctionAppSlot_authSettings(rInt int, storage string, location string, tenantID string) string {
	return fmt.Sprintf(`
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-%[1]d"
  location = "%[2]s"
...
func testAccAzureRMFunctionAppSlot_corsSettings(rInt int, storage string, location string) string {
	return fmt.Sprintf(`
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-%[1]d"
  location = "%[2]s"
...
func testAccAzureRMFunctionAppSlot_vnetName(rInt int, storage, location, vnetName string) string {
	return fmt.Sprintf(`
resource "azurerm_resource_group" "test" {
  name     = "acctestRG-%[1]d"
  location = "%[2]s"
